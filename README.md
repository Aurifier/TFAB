# `TFAB` — Time For A Budget ![Build Status](https://github.com/Aurifier/TFAB/workflows/Node.js%20CI/badge.svg)

This app is an attempt to apply YNAB (You Need A Budget)'s Four Rules to personal time management.

It is also, unfortunately, my testbed and first foray into Angular development.
